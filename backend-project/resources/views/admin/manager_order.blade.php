...
<div class="table-agile-info">
    <div class="panel panel-default">
        ...
        <div class="row w3-res-tb">
            ...
            <div class="col-sm-3">
                <form action="{{url('/search_order')}}" method="POST" class="font-form">
                    @csrf
                    <span class="input-sm">Enter Customer ID to search</span>
                    <div class="input-group">
                        <input type="number" class="input-sm form-control" name="keywords_submit" placeholder="Enter Customer ID to search" required>
        ...
        <footer class="panel-footer">
            <div class="row">
                ...
                <div class="col-sm-5 text-center">
                    <small class="text-muted inline m-t-sm m-b-sm">Show {{count($all_order) }} </small>
                </div>
                <div class="col-sm-7 text-right text-center-xs">
                    <ul class="pagination pagination-sm m-t-none m-b-none">
                        <span>{!! $all_order->render() !!}</span>
                    </ul>
                </div>
            </div>
        </footer>
