...
@section('title',$name_category->category_name)
@endforeach
@section('content')
...
<section class="new_arrivals_area section_padding_100_0 clearfix">
        ...
        <div class="row">
            <div class="col-12">
                <div class="section_heading text-center">
                    <h2>We find <i style="color: rgb(232, 149, 253);">{{ count($category_id) }}</i> Product of {{$name_category->category_name}}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row karl-new-arrivals">
            ...
            @foreach ($category_id as $key => $product)
