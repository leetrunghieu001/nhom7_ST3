...
<body>
    <section id="container">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/manager_order')}}">Manager Orders</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all_category_product')}}">List categories</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all_brand_product')}}">List Brand</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all_product')}}">List Product</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <section class="wrapper">
                ...
                <div class="footer">
                    <div class="wthree-copyright">
                        ...
                        <p>© 2021 Visitors. All rights reserved | Design by <a href="">Team 7</a></p>
                    </div>
                </div>
                <!-- / footer -->
            </section>
        ...
        <!-- <script type="text/javascript">
            // Replace the <textarea id="ckeditor1"> with a ckeditor
            // instance, using default configuration.
            CKEDITOR.config.pasterFromWordPromptCleanup = true;
            CKEDITOR.config.pasterFromWordRemoveFontStyles = false;
            CKEDITOR.config.pasterFromWordRemoveStyles = false;
        ...
        <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="{{url('public/backend/js/flot-chart/excanvas.min.js')}}"></script><![endif]-->
